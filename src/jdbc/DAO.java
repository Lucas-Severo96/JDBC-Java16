...
public class DAO {
	...
	public int incluir(String sql, Object... atributos) {
		try {
			...
			adicionarAtributos(pst, atributos);
	...
	private void adicionarAtributos(PreparedStatement pst,
			Object[] atributos) throws SQLException {
		
		int indice = 1;
		for(Object atributo: atributos) {
			if(atributo instanceof String) {
				pst.setString(indice, (String) atributo);
			}else if (atributo instanceof Integer) {
				pst.setInt(indice, (Integer) atributo);
			}
			indice++;
		}
	}
